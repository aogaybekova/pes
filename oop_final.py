...
class SpotMicroController:
    def __init__(self):
        ...
        self.pawing = False
        #pause time
        self.NEUTRAL_PAUSE_DURATION = 0.3
        ...
        self.h_amp2, self.h_amp4 = 100, 100 #80
        self.v_amp2, self.v_amp4 = 20, 60 #25
        self.stepl2, self.stepl4 = 0.4, 0.25 #was 0.2#08#0.125 #
        self.tstep2, self.tstep4 = self.stepl2 , 0.02 #0.8 #0.012 #6666666666
    ...
    def process_console_commands(self):
        if hasattr(self, 'pause_until'):
            if time() < self.pause_until:
                return  # Ждем окончания паузы, не извлекая новые команды
            else:
                delattr(self, 'pause_until')
            ...
            while self.command_queue:
                ...
                if command in movement_commands:
                    ...
                    if self.walking:
                        ...
                        reset_to_neutral()
                        self.neutral_pause_end_time = time() + self.NEUTRAL_PAUSE_DURATION
